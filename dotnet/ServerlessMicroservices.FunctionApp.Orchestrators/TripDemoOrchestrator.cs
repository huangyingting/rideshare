  ...
  public static class TripDemoOrchestrator
  {
        ...
        ILogger log)
    {
      ...
      try
      {
        ...
        trip = await context.CallActivityAsync<TripItem>("A_TD_RetrieveTrip", state.Code);
        if (trip == null)
    ...
    public static void Cleanup([ActivityTrigger] TripDemoState state,
        ILogger log)
    {
